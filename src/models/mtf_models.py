...
class HTFBias:
    ...
    sma50_slope: SMASlope = SMASlope.FLAT
    price_vs_sma50: PriceVsSMA = PriceVsSMA.BELOW
    price_vs_sma200: PriceVsSMA = PriceVsSMA.BELOW
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "sma50_slope": self.sma50_slope.value,
            "price_vs_sma50": self.price_vs_sma50.value,
            "price_vs_sma200": self.price_vs_sma200.value,
            "key_levels": [
                {
                    "price": lvl.price,
...
class MTFSetup:
    ...
    Attributes:
        ...
        confidence: Confidence score 0.0-1.0.
        sma20_action: SUPPORT, RESISTANCE, or NONE.
        sma50_action: SUPPORT, RESISTANCE, or NONE.
    ...
    direction: MTFDirection = MTFDirection.NEUTRAL
    confidence: float = 0.0
    sma20_action: Literal["SUPPORT", "RESISTANCE", "NONE"] = "NONE"
    sma50_action: Literal["SUPPORT", "RESISTANCE", "NONE"] = "NONE"
    ...
    def to_dict(self) -> dict:
        ...
        result = {
            ...
            "direction": self.direction.value,
            "confidence": round(self.confidence, 2),
            "sma20_action": self.sma20_action,
            "sma50_action": self.sma50_action,
