...
class MTFWatchlistItem(Base):
    ...
    Attributes:
        ...
        added_at: When the pair was added
        notes: Optional notes
        trading_styles: Comma-separated trading styles (e.g., "SWING,INTRADAY")
                       Default: SWING for backward compatibility
    """
    ...
    trading_styles = Column(String, nullable=True, default="SWING")  # Comma-separated: SWING,INTRADAY,DAY
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "notes": self.notes,
            "trading_styles": self.trading_styles or "SWING",
        }
    
    def get_trading_styles(self) -> list:
        """Get trading styles as a list."""
        if not self.trading_styles:
            return ["SWING"]
        return [s.strip() for s in self.trading_styles.split(",")]
