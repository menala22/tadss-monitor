...
Alignment Rules:
- 3/3 TFs aligned = HIGHEST quality (trade aggressively)
- 2/3 TFs aligned = GOOD quality (standard risk)
- 1/3 TFs aligned = POOR quality (avoid or reduce size)
- 0/3 TFs aligned = AVOID (do not trade)
"""
