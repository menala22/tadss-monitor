...
def initialize_database(verbose: bool = True) -> None:
    ...
    if verbose:
        ...
        # Ensure MTF opportunities table exists
        from src.models.mtf_opportunity_model import create_mtf_opportunities_table
        create_mtf_opportunities_table(db_manager.engine)
        if verbose:
            print("✓ MTF opportunities table ready")
