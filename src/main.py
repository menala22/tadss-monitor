...
from src.api.routes_mtf_opportunities import router as mtf_opportunities_router
...
async def lifespan(app: FastAPI):
    ...
    print(f"✓ Background scheduler running (every hour at :10 minutes)")
...
app.include_router(mtf_opportunities_router, prefix="/api/v1")
